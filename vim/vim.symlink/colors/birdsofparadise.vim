" Vim color file
" Converted from Textmate theme New BOP using Coloration v0.3.2 (http://github.com/sickill/coloration)
...
hi Cursor ctermfg=NONE ctermbg=253 cterm=NONE guifg=NONE guibg=#dddddd gui=NONE
hi Visual ctermfg=NONE ctermbg=23 cterm=NONE guifg=NONE guibg=#133054 gui=NONE
hi CursorLine ctermfg=NONE ctermbg=52 cterm=NONE guifg=NONE guibg=#3b2e26 gui=NONE
hi CursorColumn ctermfg=NONE ctermbg=52 cterm=NONE guifg=NONE guibg=#3b2e26 gui=NONE
hi ColorColumn ctermfg=NONE ctermbg=52 cterm=NONE guifg=NONE guibg=#3b2e26 gui=NONE
hi LineNr ctermfg=101 ctermbg=52 cterm=NONE guifg=#877e6d guibg=#3b2e26 gui=NONE
hi VertSplit ctermfg=59 ctermbg=59 cterm=NONE guifg=#5f5448 guibg=#5f5448 gui=NONE
hi MatchParen ctermfg=203 ctermbg=NONE cterm=NONE guifg=#ef5d32 guibg=NONE gui=NONE
hi StatusLine ctermfg=188 ctermbg=59 cterm=bold guifg=#e6e1c4 guibg=#5f5448 gui=bold
hi StatusLineNC ctermfg=188 ctermbg=59 cterm=NONE guifg=#e6e1c4 guibg=#5f5448 gui=NONE
hi Pmenu ctermfg=215 ctermbg=NONE cterm=NONE guifg=#efac32 guibg=NONE gui=NONE
hi PmenuSel ctermfg=NONE ctermbg=23 cterm=NONE guifg=NONE guibg=#133054 gui=NONE
hi IncSearch ctermfg=NONE ctermbg=59 cterm=NONE guifg=NONE guibg=#444b42 gui=NONE
hi Search ctermfg=NONE ctermbg=59 cterm=NONE guifg=NONE guibg=#444b42 gui=NONE
hi Directory ctermfg=67 ctermbg=NONE cterm=NONE guifg=#6c99bb guibg=NONE gui=NONE
hi Folded ctermfg=59 ctermbg=16 cterm=NONE guifg=#6b4e32 guibg=#281a15 gui=NONE

hi Normal ctermfg=188 ctermbg=16 cterm=NONE guifg=#e6e1c4 guibg=#281a15 gui=NONE
...
hi NonText ctermfg=58 ctermbg=52 cterm=NONE guifg=#42302d guibg=#32241e gui=NONE
...
hi SpecialKey ctermfg=58 ctermbg=52 cterm=NONE guifg=#42302d guibg=#3b2e26 gui=NONE
...
hi rubyRegexp ctermfg=32 ctermbg=NONE cterm=NONE guifg=#1e8ed0 guibg=NONE gui=NONE
hi rubyRegexpDelimiter ctermfg=32 ctermbg=NONE cterm=NONE guifg=#1e8ed0 guibg=NONE gui=NONE
